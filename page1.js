...
console.log(`Test`);
--logs it within the inspect page--
document.getElementById("ss").textContent = `Square Survey`;
--changes text from html--
let(initiation) varname = (type: boolean, number, string)

Hyperlinking image:
    <div style="position: absolute; left: 10px; top: 100px;">
        <a href="www.youtube.com" target =_blank>
            <img src="/Squares/Set1_2/red.png" id="red_submit" width="300">
        </a>
    </div>
...
Submit input:
    ...
    <input id="color">
    <button id="submit">submit/continue</button>

Clickable image???
    <input type="image" src="/Squares/Set1_2/red.png" id="red_submit">
*/
...
/*
console.log(`The count for the squares`)
document.getElementById("red_submit").onclick = function(){
    red++;
    console.log(`Red: ${red}; Green: ${green}; Blue: ${blue}`)
    return true;
}
document.getElementById("green_submit").onclick = function(){
    green++;
    console.log(`Red: ${red}; Green: ${green}; Blue: ${blue}`)
    return true;
}
document.getElementById("blue_submit").onclick = function(){
    blue++;
    console.log(`Red: ${red}; Green: ${green}; Blue: ${blue}`)
    return true;
}
...
----------------------------------------------------
randomize color array and assign colors to buttons
...
randomize button array (with color and submit id already there)
document.getElementById("red_submit").onclick = function(){
    color++
}
*/